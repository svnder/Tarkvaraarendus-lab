...
if "discount" in content:
    ...
    with open(FILE, "w", encoding="utf-8") as f:
        f.write(content)
    print("✅ Allahindlus (10% kogusele 5+) lisatud microservices/orders/app.py faili!")
    print("")
    ...
    print('  curl -X POST http://localhost:5053/orders -H "Content-Type: application/json" -d "{\\"user_id\\": 1, \\"product_id\\": 2, \\"quantity\\": 5}"')
